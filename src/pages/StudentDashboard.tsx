                    ...
                    <Card key={exam.id} className={`overflow-hidden hover:shadow-md transition-shadow ${isExpired && !app ? "opacity-60" : ""}`}>
                      ...
                      <CardContent className="space-y-3">
                        <div className="grid grid-cols-2 gap-2 text-xs">
                          <div className="flex items-center gap-1.5"><Calendar className="h-3 w-3 text-muted-foreground" /><span>Date: <strong>{exam.exam_date || "TBD"}</strong></span></div>
                          <div className="flex items-center gap-1.5"><Clock className="h-3 w-3 text-muted-foreground" /><span>Time: <strong>{exam.exam_time || "TBD"}</strong></span></div>
                          ...
                          {app ? (
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-1">
                                <div className="w-24 bg-muted rounded-full h-2"><div className="bg-primary rounded-full h-2" style={{ width: `${(app.current_step / 6) * 100}%` }} /></div>
